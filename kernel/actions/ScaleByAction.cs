...
{
    public class ScaleByAction : AbstractAction
    {
        public ScaleByAction(ActionItem item)
        {
            Action = item;
        }
        public ScaleByAction(ActionItem item, float duration, float scaleX, float scaleY, float scaleZ)
        {
            Action = item;
            Duration = duration;
            ScaleX = scaleX;
        ...
        public override string CreateCode(HashSet<string> context, string paramName)
        {
            ...
            sb.Append("    CCActionInterval * ").Append(paramName).Append(" = CCScaleBy::create(").Append(Duration).Append(",");
        ...
        {
            return "scaleBy(" + Duration + ",(" + ScaleX + "," + ScaleY + "," + ScaleZ + "))";
        }
    }
}
